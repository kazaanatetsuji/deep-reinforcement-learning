...
For this project, you will work with the [Reacher](https://github.com/Unity-Technologies/ml-agents/blob/master/docs/Learning-Environment-Examples.md#reacher) environment.Reachers has an enviroment with a sigle agent and an 20 agents. In this work, a single versions is used.
